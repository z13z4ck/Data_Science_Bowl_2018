...
def loadalldata(aug = 1, plotsample = False,size=(_IMGHEIGHT,_IMGWIDTH)):
...
batch_size = 16
Checkpoint = keras.callbacks.ModelCheckpoint(filepath=os.path.join(_WORKPATH,"stage1_model","checkpoint","weights_{epoch:02d}-{val_loss:.2f}.hdf5"))
