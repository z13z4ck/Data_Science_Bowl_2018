...
batch_size = 16
Checkpoint = keras.callbacks.ModelCheckpoint(filepath=os.path.join(_WORKPATH,"stage1_model","checkpoint","weights.{epoch:02d}-{val_loss:.2f}.hdf5"))
...
if num_gpus > 1:
    ...
    model_out = model
model_out.save_weights(filepath=os.path.join(_WORKPATH,"stage1_model","final-model-weights.hdf5"))
